  ...
  if (variant === 'admin-header') {
    return (
      <button
        ...
        className={`hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-300 transition-all shadow-xs cursor-pointer ${className}`}
